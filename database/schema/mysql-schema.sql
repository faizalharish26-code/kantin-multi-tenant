...
CREATE TABLE `commission_schemes` (
  ...
  `created_at` timestamp(6) NULL DEFAULT NULL,
  `updated_at` timestamp(6) NULL DEFAULT NULL,
  `active_lock` bigint unsigned GENERATED ALWAYS AS ((case when (`valid_to` is null) then `tenant_id` else NULL end)) VIRTUAL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `commission_schemes_tenant_id_id_unique` (`tenant_id`,`id`),
  UNIQUE KEY `uq_commission_active_per_tenant` (`active_lock`),
...
CREATE TABLE `tenant_bank_accounts` (
  ...
  `created_at` timestamp(6) NULL DEFAULT NULL,
  `updated_at` timestamp(6) NULL DEFAULT NULL,
  `primary_lock` bigint unsigned GENERATED ALWAYS AS ((case when (`is_primary` = 1) then `tenant_id` else NULL end)) VIRTUAL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tenant_bank_accounts_tenant_id_id_unique` (`tenant_id`,`id`),
  UNIQUE KEY `uq_bank_primary_per_tenant` (`primary_lock`),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2026_08_16_000001_add_role_and_status_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2026_08_16_000101_create_tenancy_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2026_08_16_000102_create_table_session_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2026_08_16_000103_create_catalog_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (10,'2026_08_16_000104_create_order_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (11,'2026_08_16_000105_create_payment_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (12,'2026_08_16_000106_create_async_audit_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (13,'2026_08_17_000101_add_admin_guards_to_schema',1);
